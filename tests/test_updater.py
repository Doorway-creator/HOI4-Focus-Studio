...
class UpdaterTests(unittest.TestCase):
    ...
    def test_update_helper_protects_every_user_data_directory(self):
        ...
        for protected in ("projects", "exports", "backups", "imports", "updates", "sources", "source_registry.json", "playset_snapshots", "diagnostics", "settings"):
    ...
    def test_release_check_sends_no_project_or_personal_data(self):
        response = b'{"tag_name":"v6.13.3","body":"notes","html_url":"https://github.com/release","assets":[]}'
